...
source("E:/LOY/scLOY/GR_LOY_microglia_github/microglia-loss-of-y/scripts/LOYtools/call_LOY.R")
source("E:/LOY/scLOY/GR_LOY_microglia_github/microglia-loss-of-y/scripts/LOYtools/loy_functions.R")
source("E:/LOY/scLOY/GR_LOY_microglia_github/microglia-loss-of-y/scripts/LOYtools/loy_summary_functions.R")
source('E:/LOY/scLOY/GR_LOY_microglia_github/microglia-loss-of-y/scripts/LOYtools/load.R')
source('E:/LOY/scLOY/GR_LOY_microglia_github/microglia-loss-of-y/scripts/LOYtools/build_data_files.R')
...
o[["ATAC_gene_activity"]]@data -> data
data %>% as.matrix() -> data
data[rownames(data) %in% expressed_PAR_genes(o),] -> PAR_counts
PAR_counts %>% colMeans() %>% as.data.frame() -> PAR
names(PAR) <- "PAR_Access"
left_join(x = tibble::rownames_to_column(o@meta.data,"CB"), y = tibble::rownames_to_column(PAR,"CB"), by = "CB" ) %>%
  tibble::column_to_rownames("CB") -> o@meta.data


subset(o, nCount_ATAC > 10000 & nFeature_ATAC > 1000) -> oo
ggboxplot(oo@meta.data[oo@meta.data$cell_ident_MV=="B tumor",],
          x = "ATAC_LOY", y = "PAR_Access", facet.by = "cell_ident_MV") + stat_compare_means()

subset(o, nCount_RNA >= 1500 & nFeature_RNA > 1000) -> oo
ggboxplot(oo@meta.data[oo@meta.data$cell_ident_MV=="B tumor",],
          x = "LOY_levels", y = "normPAR", facet.by = "cell_ident_MV") + stat_compare_means()
...
if(save == T){
ggsave(plot = out %>% ggpar(legend = "none") + NoAxes(), 
