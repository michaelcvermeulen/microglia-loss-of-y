...
ggpubr::ggboxplot(oo@meta.data[oo@meta.data$cell_ident_MV=="B tumor",],
          x = "ATAC_LOY", y = "PAR_Access", facet.by = "cell_ident_MV") + ggpubr::stat_compare_means()

subset(o, nCount_RNA >= 1500 & nFeature_RNA > 1000) -> oo
ggpubr::ggboxplot(oo@meta.data[oo@meta.data$cell_ident_MV=="B tumor",],
          x = "LOY_levels", y = "normPAR", facet.by = "cell_ident_MV") + ggpubr::stat_compare_means()
...
lapply(c(1:22,"X","Y"), function(i){
  ...
  Seurat::AverageExpression(subset(o, nCount_RNA > 1500 & nFeature_RNA > 1000), 
...
if(save == T){
ggplot2::ggsave(plot = p1, filename = "A:/Dropbox/LOY_microglia_paper/GR_RESUB/PLOTS/Fig1/UTY_GENE_ACTIVITY.pdf",
...
if(save == T){
ggplot2::ggsave(plot = p2, filename = "A:/Dropbox/LOY_microglia_paper/GR_RESUB/PLOTS/Fig1/ZFY_GENE_ACTIVITY.pdf",
       dpi = "retina", width = 7, height = 7, units = "in")}
