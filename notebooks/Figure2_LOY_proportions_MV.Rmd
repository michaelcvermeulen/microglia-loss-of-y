...
data.table::fread("h:/LOY/scLOY/scLOY_NOV18/plots/MARCH_12/FINAL/DE/COMPARE_CELL_TYPES_2/LOY_prop_table_3000_1000.txt") -> l2
...
factor(dat$neuro_degen_diagnosis, levels = c("Control","AD/MCI","HD","PD","LBD/FTLD","ALS","Brain cancer","Seizure disorder")) -> dat$neuro_degen_diagnosis
dat <- dat[dat$neuro_degen_diagnosis %in% c("AD/MCI", "Control","HD","PD","LBD/FTLD","ALS","Seizure disorder"),]
...
data.table::fread(file = "h:/LOY/scLOY/scLOY_NOV18/plots/MARCH_12/FINAL/DE/COMPARE_CELL_TYPES_2/LOY_prop_table_3000_1000.txt") -> ll
rbind(l,ll) -> l
...
ggboxplot(dat,
          ...
          xlab = "", ylab = "Loss of Y proportion", fill = "CLEAN", palette = "aaas",
          y = "LOY_prop") %>% ggpar(x.text.angle = 45, ylim = c(0,0.6), legend = "none") -> tmp
...
dat[dat$neuro_degen_diagnosis %in% c("Control","AD/MCI") & dat$cell_type == "Microglia",] 
